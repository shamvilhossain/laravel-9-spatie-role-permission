...
<head>
    ...
    <meta name="csrf-token" content="{{ csrf_token() }}">    <title>{{ config('app.name', 'Laravel 9 User Roles and Permissions Tutorial Example') }}</title>    @vite(['resources/js/app.js'])    <!-- Fonts -->
